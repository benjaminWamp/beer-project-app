                    ...
                    <div className="relative rounded-md overflow-hidden my-4">
                        <table className="w-full text-sm text-left rtl:text-right text-zinc-50">
                            <thead className="text-xs text-zinc-50 uppercase bg-accent ">
                                <tr>
                                    <th scope="col" className="w-16 font-title font-bold text-background px-6 py-3">
                                        Image Produit
                                    </th>
                                    <th scope="col" className="font-title font-bold text-background px-6 py-3">
                                        Produit
                                    </th>
                                    <th scope="col" className="font-title font-bold text-background px-6 py-3">
                                        Prix
                                    </th>
                                    <th scope="col" className="font-title font-bold text-background py-3 pr-7">
                                        Supprimer
                                    </th>
                                </tr>
                            </thead>
