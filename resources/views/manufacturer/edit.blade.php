<x-layout>
<x-slot name="title">Modifier - {{$manufacturer->name}}</x-slot>
...
{{--
    <div class="mt-3 hover:-translate-y-1 transition-all inline-block">
        <a href="{{ URL::previous() }}" class="font-title border bg-accent text-secondary rounded-md px-3 py-3 text-sm font-medium">Retour</a>
    </div>    
