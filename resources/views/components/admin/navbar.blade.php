<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="flex h-full px-3 pb-4 bg-accent pt-32 flex-col justify-between">
      <ul class="space-y-2 font-medium">
         <li >
            <a href={{route("index")}} class="{{Route::is('index') ? 'border-2 rounded-md' : ""}} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            <a href={{route("product.index")}} class="{{Route::is('product.index') ? 'border-2 rounded-md' : ""}} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               <svg class="w-6 h-6 text-white group-hover:text-accent" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="3 0 22 22">
               ...
               <span class="flex-1 ml-2 text-white group-hover:text-accent font-title">Bières</span>
            </a>
         </li>
         <li>
            <a href={{route("category.index")}} class="{{Route::is('category.index') ? 'border-2 rounded-md' : ""}} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="flex-1 ms-3 text-white group-hover:text-accent font-title">Catégories</span>
            </a>
         </li>
         <li>
         ...
         <li>
            <a href={{route("database.index")}} class="{{Route::is('database.index') ? 'border-2 rounded-md' : ""}} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-accent" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
