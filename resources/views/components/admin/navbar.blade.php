<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-accent pt-32">
      <ul class="space-y-2 font-medium">
         ...
         <li class="{{Route::is('product.index') ? 'border-2 rounded-md' : ""}}">
            <a  href={{route("product.index")}} class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li >
            <a  class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-primary bg-secondary rounded-full font-title ">3</span>
            </a>
         </li>
         <li class="{{Route::is('users.index') ? 'border-2 rounded-md' : ""}}">
         ...
         <li class="{{Route::is('manufacturer.index') ? 'border-2 rounded-md' : ""}}">
            <a href="{{route("manufacturer.index")}}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               <svg class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-accent" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
