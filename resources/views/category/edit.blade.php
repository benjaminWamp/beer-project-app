    ...
    <div class="container mx-auto mt-10">
        <form action="{{ route('category.update',$category) }}" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                @enderror
                <div class="mt-2.5">
                    <input type="text" name="adress" id="adress" value="{{$category->adress}}" class="block border w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>               
            </div>
            <div>
