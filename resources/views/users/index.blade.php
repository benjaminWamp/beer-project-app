...
<div class="relative overflow-x-auto">
    <a href="{{route("users.create")}}" class="font-title border bg-accent text-secondary rounded-md px-3 py-2 text-sm font-medium hover:-translate-y-1 transition-all">Ajouter un Utilisateur +</a>
        ...
        <tbody>
            @foreach($users as $user)
             ...
             <tr class="bg-secondary border-b text-slate-950">
                ...
                <td class="px-6 py-4">
                <a href="{{route("users.editRole", $user)}}">
