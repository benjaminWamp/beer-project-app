    ...
    <div class="mt-4 flex flex-col gap-4">
        <div>
            ...
            <div class="flex flex-row gap-4">
                <div class="flex ">
                    <h2 class="mt-4 mr-4 font-title text-2xl leading-none font-semibold leading-6 text-accent">Produit&nbsp;:</h2>
                ...
                <div class="flex">
                    <h2 class="mt-4 mr-4 font-title text-2xl leading-none font-semibold leading-6 text-accent">Note&nbsp;:</h2>
