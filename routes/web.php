...
Route::middleware(["auth"])->group(function () {
    ...
    Route::get('/admin/categories-recherche', CategoryController::class . "@search")->name("category.search");
    ...
    Route::get('/admin/producteurs-recherche', ManufacturerController::class . "@search")->name("manufacturer.search");
    ...
    Route::get('/admin/avis-recherche', ReviewController::class . "@search")->name("review.search");
    ...
    Route::get('admin/commandes-recherche', OrderController::class . "@search")->name("orders.search");
